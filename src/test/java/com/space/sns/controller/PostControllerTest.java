...
import com.space.sns.controller.request.PostCommentRequest;
...
public class PostControllerTest {
    ...
    @Test
    @WithAnonymousUser
    void 좋아요시_로그인하지_않은경우() throws Exception {
    ...
    @Test
    @WithMockUser
    void 좋아요시_게시물이_없는경우() throws Exception {
    ...
    void 댓글작성시_게시물이_없는경우() throws Exception {
        doThrow(new SnsApplicationException(ErrorCode.POST_NOT_FOUND)).when(postService).comment(any());
